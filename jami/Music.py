...
solfege = ['Do', 'Ra', 'Re', 'Me', 'Mi',
           'Fa', 'Fi', 'So', 'Si', 'La', 'Te', 'Ti']
diatonicPitches = ['00', '02', '04', '05', '07', '09', '11']
allPitches = ['00', '01', '02', '03', '04',
    ...
    for note in notes:
        for harmony in diatonicPitches:
            ...
            if Database.harmonicDatabase.has_key(key):
                ...
                for i in notes:
                    # if this is the same as the other notes on this beat, make it less likely
                    if i == int(key[:2]):
                        number /= 2
                while n < number:
                    options.append(key)
...
def randomHarmonize():
    ...
    # Database.weightedRandom[random.randint(0, len(Database.weightedRandom) - 1)]
    pick = allPitches[random.randint(0, 11)]
    return pick
